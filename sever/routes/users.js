...
// router.get('/add',checklogin.requiresLogin,userCtrl.add);
router.post('/add',uploadAvatarProduct.single("avata"),checklogin.requiresLogin,userCtrl.add);


router.get('/edit/:idus',checklogin.requiresLogin,userCtrl.editUs);
router.post('/edit/:idus',uploadAvatarProduct.single("avata"),checklogin.requiresLogin,userCtrl.editUs);
