...
// router.get('/add',checklogin.requiresLogin,spCtrl.add);
// router.post('/add',uploadAvatarProduct.single("avatar"),checklogin.requiresLogin,spCtrl.add);



// router.get('/edit/:idpd',checklogin.requiresLogin,spCtrl.editProduct);
// router.post('/edit/:idpd',uploadAvatarProduct.single("avatar"),checklogin.requiresLogin,spCtrl.editProduct);
